  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active" style="font-weight: 700"><a href="<?= base_url() ?>">HOME</a></li>
          <li><a href="<?= site_url('auth/edit/' . $this->session->userdata('userid')) ?>">Edit Profile</a></li>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h3>Berikut Menu <span>Ask Unla</span></h3>
          <p>Pilih menu yang akan dituju oleh Anda.</p>
        </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('requests') ?>">
                <div class="icon-box">
                  ...
                  <h4 class="title">Manage Request</h4>
                  <p class="description">Management Data Request Ask Unla</p>
                </div>
              </a>
            </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('contacts') ?>">
                <div class="icon-box">
                  ...
                  <h4 class="title">Manage Contact</h4>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('users') ?>">
                <div class="icon-box">
                  ...
                  <p class="description">Management Data User Ask Unla</p>
                </div>
              </a>
            </div>
        ...
        <?php } else if ($this->session->userdata('type') == 'Super Administrator') { ?>
          <div class="row" style="display: flex;  justify-content: center">
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('spadmin') ?>">
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-user-cog"></i></div>
                  <h4 class="title">Manage Administrator</h4>
                  <p class="description">Manage User Admin Ask Unla</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="row" style="display: flex;  justify-content: center">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('requests/cont_general') ?>">
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-address-book"></i></div>
                  <h4 class="title">All General Contact List</h4>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <a href="<?= site_url('requests/history/' . $id) ?>">
                <div class="icon-box">
                  <div class="icon"><i class="fas fa-history"></i></div>
                  <h4 class="title">History Request Contact</h4>
                  <p class="description">All History Request Contact Ask Unla</p>
                </div>
              </a>
            </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Kami Mahasiswa Jurusan Teknik Informatika di Universitas Langlangbuana.</p>
        </div>
...
<body>
    ...
    <hr>
    <h4>Welcome <?= $this->session->userdata('fullname') ?>, you are login as <?= $this->session->userdata('type') ?> </h4>
    <ul>
        <li><img src="<?= base_url('uploads/users/' . $this->session->userdata('photo')) ?>" width="128" height="128" style="border-radius: 50%;"></li>
        <li><a href="<?= site_url('auth/edit/' . $id) ?>">Edit Profile</a></li>
        <li><a href=" <?= site_url('auth/changephoto') ?>">Change Photo</a></li>
        <li><a href="<?= site_url('auth/changepass') ?>">Change Password</a></li>
