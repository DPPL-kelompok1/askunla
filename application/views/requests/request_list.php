      ...
      <div class="container">
        <?php if ($this->session->userdata('type') == 'Administrator') { ?>
          <div class="section-title">
            ...
            <h3>Manage Requests <span>Ask Unla</span></h3>
            <p>Daftar Request Contact Universitas Langlangbuana.</p>
          </div>
        <?php } else { ?>
          <div class="section-title">
            <h2>HISTORY REQUESTS CONTACT</h2>

            <h3>History Request Contact <span>Ask Unla</span></h3>
            <p>Daftar History Request Contact Universitas Langlangbuana.</p>
          </div>
        <?php } ?>
    ...
    <table id="customers">
      ...
      foreach ($requests as $req) { ?>
        <tr>
          ...
          <?php if ($this->session->userdata('type') == 'Administrator') { ?>
            <td>
              <?php if ($req->respons == '1') echo 'Status Updated';
              else { ?> <a href="<?= site_url('requests/responsacc/' . $req->req_id) ?>">Accept</a> <?php } ?>
            </td>
            <td>
              <?php if ($req->respons == '1') echo 'Status Updated';
              else { ?> <a href="<?= site_url('requests/responsdec/' . $req->req_id) ?>" onclick="return confirm('Are You Sure to Reject?')">Reject</a> <?php } ?>
            </td>
            <td>
              <?php if ($req->sendmail == '1') echo 'Email Sent';
              else { ?> <a href="<?= site_url('requests/sendmailprivate/' . $req->req_id) ?>">Send Mail</a> <?php } ?>
            </td>
          <?php } ?>
        </tr>
      <?php } ?>
    ...
    foreach ($requests as $req) { ?>
			<tr>
				...
				<?php if ($this->session->userdata('type') == 'Administrator') { ?>
					...
					<td>
						<?php if ($req->respons == '1') echo 'Status Updated';
            else { ?> <a href="<?= site_url('requests/responsdec/' . $req->req_id) ?>">Reject</a> <?php } ?>
					</td>
					<td>
						<?php if ($req->sendmail == '1') echo 'Email Sent';
            else { ?> <a href="<?= site_url('requests/sendmailprivate/' . $req->req_id) ?>">Send Mail</a> <?php } ?>
