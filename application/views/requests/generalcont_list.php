...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="<?= site_url('requests/cont_general') ?>">General Contact List</a></li>
  ...
  <main id="main">
    ...
    <div class="container">
       ...
       <div class="section-title">
          <h2>GENERAL CONTACT LIST</h2>
          
		  <h3>GENERAL CONTACT LIST  <span>Ask Unla</span></h3>
          <p>Daftar Contact Universitas Langlangbuana.</p>
        </div>
