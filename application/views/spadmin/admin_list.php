    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="<?= site_url('users') ?>">Manage Users</a></li>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h3>Manage Users <span>Ask Unla</span></h3>
          <p>Daftar Users Admin / Mahasiswa Universitas Langlangbuana.</p>
        </div>
        <div class="add">
          <a href="<?= site_url('spadmin/add') ?>">
    ...
    <table id="customers">
      ...
      foreach ($user as $usr) { ?>
        <tr>
          ...
          <td><?= $usr->fullname ?></td>
          <td><?= $usr->type ?></td>
          <td><?= $usr->no_identitas ?></td>
          <td style="font-size:12px;"><?= $usr->alamat ?></td>
          ...
          <td><a href="<?= site_url('spadmin/delete/' . $usr->userid) ?>" onclick="return confirm('Are you sure?')" title="DELETE"><i class="fas fa-minus-circle" style="font-size:30px; color:red;"></i></a></td>
          <td>
            <?php if ($usr->verifikasi == '1') echo 'Verified';
            else { ?> 
				<div class="veri">
					<a href="<?= site_url('spadmin/verify/' . $usr->userid) ?>">Verify</a> 
				</div>				
			<?php } ?>
          </td>
        </tr>
...
<body>
    ...
    foreach ($user as $usr) { ?>
			<tr>
				...
				<td><?= $usr->alamat ?></td>
				<td><?= $usr->jenis_kelamin ?></td>
				<td><?= $usr->tmpt_tgl_lahir ?></td>
				<td><?= $usr->no_telp ?></td>
				<td><?= $usr->email ?></td>
				<td><a href="<?= site_url('users/edit/' . $usr->userid) ?>">Edit</a></td>
				<td><a href="<?= site_url('users/delete/' . $usr->userid) ?>" onclick="return confirm('Are You Sure?')">Delete</a></td>
				<td>
					<?php if ($usr->verifikasi == '1') echo 'Verified';
          else { ?> <a href="<?= site_url('users/verify/' . $usr->userid) ?>">Verify</a> <?php } ?>
				</td>
			</tr>
		<?php } ?>
	</table>
