...
<style>
  .page-wrapper {
    min-height: 100vh;
    background: url("../../assets/img/user-bg.jpg") top center;
      ...
      <div class="card card-4" style="opacity:0.9">
		...
		-->
            <div class="row row-space">
              ...
              <div class="col-2">
                <a href="<?= site_url('spadmin') ?>"><input type="button" value="CANCEL" class="btn"></a>
              </div>
            </div>
          </form>
        </div>
  ...
  ?>
	<form action="" method="post">
		<table>
			...
			<tr>
				<td>No Identitas</td>
				<td><input type="number" name="no_identitas" value="<?= set_value('no_identitas', $noidentitas) ?>" required></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td><input type="text" name="alamat" value="<?= set_value('alamat', $alamat) ?>" required></td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td>
					<input type="radio" name="jenis_kelamin" value="Laki-Laki" <?= set_radio('jenis_kelamin', 'Laki-Laki', $type == 'Laki-Laki' ? TRUE : FALSE) ?> required>Laki-Laki 
					<input type="radio" name="jenis_kelamin" value="Perempuan" <?= set_radio('jenis_kelamin', 'Perempuan', $type == 'Perempuan' ? TRUE : FALSE) ?> required>Perempuan
				</td>
			</tr>
			<tr>
				<td>Tempat Tanggal Lahir</td>
				<td><input type="text" name="tmpt_tgl_lahir" value="<?= set_value('tmpt_tgl_lahir', $TTL) ?>" required></td>
			</tr>
			<tr>
				<td>Telepon</td>
				<td><input type="number" name="no_telp" value="<?= set_value('no_telp', $telp) ?>" required></td>
			</tr>
			<tr>
				<td>E-Mail</td>
